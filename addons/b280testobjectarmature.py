...
def register():
    ...
    #default=True
    bpy.types.Scene.bobjmesh= BoolProperty(name='Mesh')
    bpy.types.Scene.bobjarmature = BoolProperty(name='Armature')
    bpy.types.Scene.bobjtest = BoolProperty(name='Test')
