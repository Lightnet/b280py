...
# https://blender.stackexchange.com/questions/111645/python-how-to-select-one-boolvectorproperty-value-at-a-time-unless-shift-ke

bl_info = {
    "name": "Custom props_popup test",
    "author":"none",
    "version":(0,0,1),
    "blender": (2,80,0),
    "location": "none",
